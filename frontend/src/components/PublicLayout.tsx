    ...
    <div className="public-site">
      <header className="public-nav">
        <Link className="public-brand" to="/" aria-label="AGATA home" onClick={() => setMenuOpen(false)}>
          <span className="logo-badge"><img src="/agata-mark.svg" alt="AGATA" /></span>
        </Link>
      ...
      <footer className="public-footer">
        <div>
          <Link className="public-brand footer-brand" to="/"><span className="logo-badge"><img src="/agata-mark.svg" alt="AGATA" /></span></Link>
